...
$(document).ready( function(){
    ...
    $('#btn_iniciar_jogo').click( function(){
       ...
       // para validar a digitação dos apelidos dos jogadores nos inputs
        ...
        // exibir os apelidos dos jogadores em baixo da imagem
    ...
    $('.jogada').click( function(){
        ...
        $('#'+id_campo_clicado).off(); // para retirar a função de clique duas vezes
	...
	function ganhador(pontos){
		if(pontos == -3){
			var jogada_1 = $('#apelido_jogador_1').val();
			alert(jogada_1 + ' é o vencedor');
			$('.jogada').off();
		
		} else if(pontos == 3){
			var jogada_2 = $('#apelido_jogador_2').val();
